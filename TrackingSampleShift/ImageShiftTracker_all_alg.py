...
import pytz
import datetime
from Algorithms.Algorithm1  import _upsampled_dft
...
print(nPixelClockMax)
print(repr(nPixelClockMax))
...
for i in range(1, 33300):
    ...
    if nret == ueye.IS_SUCCESS:
        ...
        frame = np.pad(frame, (20, 30), 'constant', constant_values=(0, 0))
        print(counter)
        ...
        alg4_offset = cv2.phaseCorrelate(reference_images[0],  frame)[0]
        alg4_x_pixel_offset.append(-alg4_offset[0])
        alg4_y_pixel_offset.append(-alg4_offset[1])
        ...
        #vancouver_current_datetime = dateqgtime.datetime.now(tz)
        #image_path = r"C:\Users\valmzztt.stu\My Python Scripts\Thorlabs Camera\Images\Images_0712\qimage{}_takenat_{}.png".format(index, date_string)
...
with open('pixel_vs_displ.csv', 'w', newline='') as csvfile:
    ...
    data = list(zip(indexes,alg1_x_pixel_offset, alg1_y_pixel_offset, alg2_x_pixel_offset, alg2_lp_x_pixel_offset, alg2_y_pixel_offset, alg2_lp_y_pixel_offset, alg3_x_pixel_offset, alg3_y_pixel_offset, alg4_x_pixel_offset, alg4_lp_x_pixel_offset, alg4_y_pixel_offset, alg4_lp_y_pixel_offset, time_images))
...
os.rename(r"C:\Users\valmzztt.stu\My Python Scripts\Thorlabs Camera\PyuEye\pixel_vs_displ.csv", r"C:\Users\valmzztt.stu\My Python Scripts\Thorlabs Camera\Vibrations_0809\vibration_data.csv")
