...
class CameraWidget(QWidget):
    ...
    def setupAlgorithmToolbar(self, name):
        ...
        lbl = QLabel("Low Threshold:")
        self.algo.addWidget(lbl)
        self.lowThreshSpin = QSpinBox()
        self.lowThreshSpin.setRange(0, 255)
        self.lowThreshSpin.setToolTip("Adjust lower threshold")
        self.lowThreshSpin.setValue(60)
        self.algo.addWidget(self.lowThreshSpin)
        self.algo.addSeparator()
        lbl = QLabel("High Threshold:")
        self.algo.addWidget(lbl)
        ...
        self.algo.addSeparator()
        lbl = QLabel("Area Allowance:")
        self.algo.addWidget(lbl)
        self.areaSpin = QDoubleSpinBox()
        self.areaSpin.setRange(0, 1000)
        self.areaSpin.setToolTip("Adjust area difference allowed")
        self.areaSpin.setValue(100)
        self.algo.addWidget(self.areaSpin)
        self.algo.addSeparator()
        lbl = QLabel("% Shape Difference:")
        self.algo.addWidget(lbl)
        self.shapeSpin = QDoubleSpinBox()
        self.shapeSpin.setRange(0, 100)
        self.shapeSpin.setToolTip("Adjust sample shape difference % allowed")
        self.shapeSpin.setValue(5)
        self.algo.addWidget(self.shapeSpin)
        self.algo.addSeparator()
    ...
    def setupCamDaemon(self):
        ...
        self.lowThreshSpin.valueChanged[int].connect(self.camD.setLowThreshold)
        self.highThreshSpin.valueChanged[int].connect(self.camD.setHighThreshold)
        self.shapeSpin.valueChanged[float].connect(self.camD.changeSampleDiff)
        self.areaSpin.valueChanged[float].connect(self.camD.changeAreaAllowance)
