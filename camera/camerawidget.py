...
class CameraWidget(QWidget):
    ...
    def setupAlgorithmToolbar(self, name):
        ...
        self.algo.addSeparator()
        lbl = QLabel("% Difference:")
        self.algo.addWidget(lbl)
        self.areaSpin = QDoubleSpinBox()
        self.areaSpin.setRange(0, 100)
        self.areaSpin.setToolTip("Adjust sample shape difference % allowed")
        self.areaSpin.setValue(5)
    ...
    def setupCamDaemon(self):
        ...
        self.areaSpin.valueChanged[float].connect(self.camD.changeSampleDiff)
